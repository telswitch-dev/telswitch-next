	...
	>
		<div class="section-inner">
			<div class="flex-[2] self-center">
				<h2
					class="relative inline-block bg-gradient-to-r from-ts-orange-coral-400 to-ts-green-mineral-600 bg-clip-text text-5xl font-extrabold uppercase leading-none text-surface-1 text-transparent drop-shadow-outline max_m_xl:text-3xl"
				>
